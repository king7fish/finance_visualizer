...
st.markdown(
    f"<h1 style='text-align:center;color:{PRIMARY};margin-bottom:4px'>🏆 Finance Dashboard Elite+ v3</h1>"
    "<p style='text-align:center;color:#6b7280;font-size:17px;'>Dual-axis control • Reliable exports • Analyst-grade insights</p>",
